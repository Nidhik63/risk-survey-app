...
export default function ReportHeader({ siteDetails, date }: ReportHeaderProps) {
  return (
    <div className="rounded-2xl bg-gradient-to-r from-[#3D1556] to-[#5B2D8E] p-6 text-white shadow-lg sm:p-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight">NTRU</h1>
      ...
      <div className="mt-6 grid gap-3 rounded-xl bg-white/10 p-4 backdrop-blur-sm sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs text-purple-200">Building Type</p>
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs text-purple-200">Year Built</p>
            <p className="text-sm font-medium">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs text-purple-200">Surveyor</p>
            <p className="text-sm font-medium">
